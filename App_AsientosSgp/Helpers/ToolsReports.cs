...
{
    public static class ToolsReports
    {
        ...
        public enum TiposReportes
        {
            ...
            //MapaTrafico= 1000,
            //OrdenServicio =1001,
            //OrdenServicioTodos = 1002,

            //CotizacionResumen = 1500,
          
            //ReservaResumen =2000,
            //ReservaProveedor = 2001,
            //ReservaProveedorServicio =2002,
            //ReservaProveedorHotel=2003,
           ...
           settings.ValidationType = ValidationType.Schema;
            ...
            if (nameValueFormulas != null)
            {
                ...
                foreach (string key in nameValueFormulas.Keys )
                {
                    ...
                    value.Value = nameValueFormulas[key];
